...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /(\.scss|\.css)$/, loader: 'style!css?reducers&modules&importLoaders=1&sourceMap&localIdentName=[local]___[hash:base64:5]!autoprefixer?browsers=last 2 version!resolve-url!sass?outputStyle=expanded&sourceMap' },
