...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /(\.scss|\.css)$/, loader: ExtractTextPlugin.extract('style', 'css?reducers&importLoaders=2&sourceMap!autoprefixer?browsers=last 2 version!resolve-url!sass?outputStyle=expanded&sourceMap=true&sourceMapContents=true') },
